...
MAKECMD         = /usr/local/MATLAB/R2018b/bin/glnxa64/gmake
HOST            = UNIX
BUILD           = yes
...
MODEL                  = boat_control
MODULES                = rt_logging.c boat_control.c boat_control_capi.c boat_control_data.c boat_control_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi.c rtw_modelmap_utils.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c
MAKEFILE               = boat_control.mk
MATLAB_ROOT            = /usr/local/MATLAB/R2018b
ALT_MATLAB_ROOT        = /usr/local/MATLAB/R2018b
MATLAB_ROOTQ           = \"/usr/local/MATLAB/R2018b\"
MASTER_ANCHOR_DIR      = 
START_DIR              = /home/davidm/Documents/Projects/P5/matlab_ws/boat_simulation
...
COMPUTER               = GLNXA64
BUILDARGS              =  MODELLIB=boat_controllib.a RSIM_SOLVER_SELECTION=2 PCMATLABROOT="/usr/local/MATLAB/R2018b" EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 TMW_EXTMODE_TESTING=0 COMBINE_OUTPUT_UPDATE_FCNS=0 INCLUDE_MDL_TERMINATE_FCN=1 MULTI_INSTANCE_CODE=0 MODELREF_TARGET_TYPE=NONE ISPROTECTINGMODEL=NOTPROTECTING OPTS="-DTGTCONN -DEXT_MODE -DON_TARGET_WAIT_FOR_START=0"
...
ADDITIONAL_LDFLAGS  = 
DEFINES_CUSTOM      = 
SYSTEM_LIBS         = -L"/usr/local/MATLAB/R2018b/bin/glnxa64" -lmwipp -lut -lmx -lmex -lmat -lmwmathutil -lmwslexec_simbridge -lmwsl_fileio -lmwsigstream -lmwsl_AsyncioQueue -lmwsl_simtarget_instrumentation -lmwsl_services -lmwsdi_raccel -lmwsl_log_load_blocks -lfixedpoint -lmwslexec_simlog -lm -lpthread -ldl
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/boat_control \
